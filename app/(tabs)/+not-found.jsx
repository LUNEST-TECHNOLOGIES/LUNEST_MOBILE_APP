/**
 * Guest Tabs Not Found Screen
 * Handles routing errors within the Guest (tabs) navigation
 * 
 * Ensures users stay in Guest mode when a routing error occurs.
 */
...
export default function GuestTabsNotFoundScreen() {
  ...
  // Try to go back within Guest mode
  const handleGoBack = () => {
    if (router.canGoBack()) {
      router.back();
    } else {
      // Can't go back, go to Guest home
      handleGoHome();
    }
  };
      ...
      <View style={styles.content}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity style={styles.primaryButton} onPress={handleGoHome}>
            ...
            <Text style={styles.primaryButtonText}>Go to Guest Home</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
