...
const PROPERTY_CATEGORIES = [
  ...
  { id: 'mini-flat', label: 'Mini Flat', icon: Home, color: '#F0F4FF' },
  { id: 'room-parlor', label: 'Room & Parlor', icon: DoorOpen, color: '#F5FFF0' },
  { id: 'self-contain', label: 'Self-Contain', icon: DoorOpen, color: '#FFF9F0' },
  { id: 'tenement', label: 'Tenement House', icon: Building, color: '#FFF0F0' },
  ...
  { id: 'serviced-apartment', label: 'Serviced Apartment', icon: Building, color: '#F5FFF5' },
  { id: 'townhouse', label: 'Townhouse', icon: Rows, color: '#F0F5FF' },
  { id: 'villa', label: 'Villa', icon: Home, color: '#FFF5F5' },
  { id: 'cottage', label: 'Cottage', icon: Home, color: '#F5FFF0' },
  { id: 'guest-house', label: 'Guest House', icon: Hotel, color: '#F0F5FF' },
  { id: 'shared-room', label: 'Shared Room', icon: Users, color: '#F5F5F5' },
  ...
  { id: 'kiosk', label: 'Kiosk/Stall', icon: Store, color: '#F5FFF5' },
