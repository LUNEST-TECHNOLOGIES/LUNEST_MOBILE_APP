...
const MessageEmptyIcon = ({ size = 64, color = "#9CA3AF" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export default function MessagesScreen() {
  ...
  const filteredConversations = conversations.filter((c) => {
    ...
    const hostName = (c.host?.fullName || "").toLowerCase();
    const listingTitle = (
    ...
    return hostName.includes(q) || listingTitle.includes(q) || lastMsg.includes(q);
  });
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyWrapper}>
              <MessageEmptyIcon size={64} color="#D1D5DB" />
              <Text style={styles.emptyTitle}>No messages yet</Text>
              <Text style={styles.emptySubtext}>
                When you contact a host about a property on LUNEST, your conversations will appear here.
              </Text>
              <TouchableOpacity
